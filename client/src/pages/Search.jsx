       ...
       <div className='p-7 border-slate-300 border-b-2 md:border-r-2 md:min-h-screen'>
          <form onSubmit={handleSubmit} className='flex flex-col gap-5'>
            <div className='flex items-center gap-2'>
              ...
              <input type="text" id='searchTerm' placeholder='Search...' className='border border-slate-300 rounded-lg p-3 w-full' value={sidebardata.searchTerm} onChange={handleChange} />
            </div>
            ...
            <div className='flex items-center gap-2'>
                ...
                id="sort_order" className='border border-slate-300 rounded-lg p-3'>
       ...
       <div className='flex-1'>
          ...
          <div className='p-7 flex flex-wrap gap-4'>
            {!loading && listings.length === 0 && (
                <p className='text-xl text-center text-slate-700'>No listings found matching your criteria.</p>
            )}
            {loading && (
            ...
            {showMore && (
                <button onClick={onShowMoreClick} className='text-green-700  mt-7 cursor-pointer hover:underline hover:opacity-90'>
                    Show More
                </button>
            ) }</div>
          </div>
