    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-10'>
          <div className='flex flex-col gap-4 flex-1'>
            <input type="text" placeholder='Name' className='border border-slate-300 p-3 rounded-lg' id='name' maxLength='62' minLength='5' required onChange={handleChange} value={formData.name} />
          ...
          <button disabled={loading || uploading} className='font-semibold text-white p-3 bg-slate-700 rounded-xl uppercase hover:opacity-80 hover:shadow-lg hover:cursor-pointer disabled:opacity-50'>{loading ? "Creating..." : "Create Listing"}</button>
